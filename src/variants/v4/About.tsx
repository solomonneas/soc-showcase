    ...
    <div className="paper-wrapper paper-body">
        ...
        <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <p style={{ marginBottom: '0.5rem' }}>
              ...
              architectures. Creator of the S³ Stack and its constituent MCP
              integrations.
            </p>
            <div
              style={{
      ...
      <motion.div {...fade} transition={{ delay: 0.1, duration: 0.5 }}>
        ...
        <p style={{ marginBottom: '1rem' }}>
          ...
          throughout this paper. Items [1]–[{tools.length}] refer to S³ Stack
      ...
      <motion.div {...fade} transition={{ delay: 0.15, duration: 0.5 }}>
        ...
        <p>
          ...
          like the S³ Stack possible. Special recognition is due to the Anthropic team
      ...
      <motion.div {...fade} transition={{ delay: 0.2, duration: 0.5 }}>
        ...
        <p>
          All S³ Stack components are released under permissive open-source licenses.
      ...
      <div className="footnotes-section">
        <div className="footnote-item">
          ...
          and reflects the state of the S³ Stack at that time. Component status and
